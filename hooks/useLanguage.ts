...
const translations = {
  en: {
    ...
    tutorialMapControlsDesc: 'Use these buttons to locate yourself on the map, switch map styles, and access this tutorial anytime.',
    ...
    tutorialSharedMaps: 'Share with Friends',
    tutorialSharedMapsDesc: 'Create shared maps to collaborate with friends and family. Share a 4-digit code and everyone can add memories to the same map!',
  ...
  zh: {
    ...
    tutorialMapControlsDesc: '使用这些按钮定位自己、切换地图样式，随时可以再次启动本教程。',
    tutorialAddButton: '添加新记忆',
    tutorialAddButtonDesc: '点击 + 按钮添加新体验。搜索地点、添加照片、评分并写下你的感想！',
    tutorialSharedMaps: '与朋友分享',
    tutorialSharedMapsDesc: '创建共享地图与朋友家人协作。分享4位数代码，大家都可以在同一张地图上添加记忆！',
